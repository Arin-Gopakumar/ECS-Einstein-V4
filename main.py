...
model_id = "moonshot-updated/1"
roboflow_api_key = "fCsLSHS3kDjh9m2yYlyU"
...
def calculate_tumor_location(frame):
    ...
    if ai_mode_enabled:
        ...
        # prediction2 = client2.infer(tmp_file.name)
        # predictions_list2 = prediction2['predictions']

        total_list = predictions_list  # + predictions_list2
        ...
        if count > 0:
            ...
            tumorY = midpoint_y
        # else:
        # print("Key 'points' does not exist in detection dictionary.")
